...
import { updateProductRequest } from "../../store/shopping/shopping.actions";
...
export default function EditProduct(props) {
  ...
  useEffect(() => {
    setitemName(props.product.name);
    setBannerImageSrc(props.product.images);
    setstockQuantity(props.product.quantity);
    setitemDescription(props.product.descriptions);
    setitemPrice(props.product.price);
    setshippingFee(props.product.shippingFee)
  }, [props.product])
  ...
  const handleClick = () => {
    ...
    if (uploadProductResponse.bucket) {
      data.images = `https://${uploadProductResponse.bucket}.s3.ap-southeast-1.amazonaws.com/${uploadProductResponse.key}`;
      data.attachments = uploadProductResponse._id;
    }
          ...
          <div className="col-12 col-lg-12 col-md-12 py-4">
            ...
            <div className="row">
              <div className="col-lg-6 col-md-12 col-12">
                <label className="text-bold"><img src={Two} />Item price</label>
                <div className="snippet-cont">
